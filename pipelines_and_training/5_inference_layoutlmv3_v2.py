...
def main():
    ...
    parser.add_argument("--model-dir", type=str, default="./layoutlmv3-avir-kie-best-v2")
    ...
    parser.add_argument("--preprocess", action="store_true", help="Apply reading order preprocessing")
    ...
    if args.preprocess:
        ...
        print("Applied reading order sorting (Text Preprocessing).")
