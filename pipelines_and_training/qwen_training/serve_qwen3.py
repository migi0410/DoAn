...
3. Nếu tên một món hàng dài bị in rớt xuống nhiều dòng, hãy ghép lại thành một tên món hoàn chỉnh duy nhất vào trường 'name'.
...
5. Nếu hóa đơn không in đơn giá riêng hoặc không có số lượng, hãy để giá trị là "".
