...
print("2. Loading Label Studio labels with EXIF-corrected dimensions...")
ls_folders = [
        ...
        if file.endswith('.json'):
            with open(os.path.join(folder, file), 'r', encoding='utf-8') as f:
                ...
                for task in tasks:
                    ...
                    # Get EXIF-corrected image dimensions
                    ...
                    if os.path.exists(actual_img_path):
                        with Image.open(actual_img_path) as im:
                            # Apply EXIF rotation to get the dimensions Label Studio used!
                            im_exif = ImageOps.exif_transpose(im)
                            actual_w, actual_h = im_exif.size
