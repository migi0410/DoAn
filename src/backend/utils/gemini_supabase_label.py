...
FOLDER_TO_PROCESS = 'cafe_starbucks'
MAX_IMAGES = 100
...
def call_gemini_rest_api(image_data):
    ...
    payload = {'contents': [{'parts': [{'text': PROMPT}, {'inline_data': {'mime_type': 'image/jpeg', 'data': base64.b64encode(image_data).decode('utf-8')}}]}], 'generationConfig': {'temperature': 0.1}}
