...
if __name__ == '__main__':
    ...
    copy_images_to_flat_folder('filtered_templates/vincommerce_winmart_vinmart.txt', train_images_dir, 'vincommerce_flat_images')
    copy_images_to_flat_folder('filtered_templates/saigon_coop_coopmart_coop_food.txt', train_images_dir, 'saigon_coop_flat_images')
